  ...
  width(_width), height(_height), fps(_fps), rgb_frame(NULL)
{
  ...
  try
  {
    ...
    set_control(10094851, 128); // Exposure, Auto Priority
    set_control(10094849, 128); // Exposure, Auto
    ...
    set_control(9963804, 128); //Backlight Compensation
